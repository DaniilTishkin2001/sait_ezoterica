...
(function(){let e=!1,t=!1,n=0;function o(){const o=window.pageYOffset||document.documentElement.scrollTop;o>n&&o>100?document.querySelector(".header")&&(document.querySelector(".header").style.transform="translateY(-100%)"):document.querySelector(".header")&&(document.querySelector(".header").style.transform="translateY(0)"),n=o,t||(window.requestAnimationFrame(r),t=!0)}function r(){const t=window.pageYOffset||document.documentElement.scrollTop,n=document.documentElement.scrollHeight-window.innerHeight,o=t/n;e&&o>90&&o<110||(e=!0,document.querySelectorAll(".lazy-load").forEach(e=>{e.getBoundingClientRect().top<window.innerHeight+200&&(e.classList.add("loaded"),e.style.opacity="1")}),setTimeout(()=>{e=!1},100))}window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",()=>{n=0},!1)})();

// Optimized Carousel
(function(){let e=0,t=null,n=null,o=3;function r(){const t=window.innerWidth;return t<768?1:t<1024?2:3}function c(){return Math.max(0,n.length-o)}function l(){if(t=document.querySelector(".carousel-track"),n=document.querySelectorAll(".carousel-item"),!t||!n.length)return;o=r();const e=document.querySelector(".carousel-btn-prev"),c=document.querySelector(".carousel-btn-next");e&&e.removeAttribute("onclick"),c&&c.removeAttribute("onclick"),e&&(e.onclick=()=>i()),c&&(c.onclick=()=>s()),e&&(e.style.display="flex"),c&&(c.style.display="flex"),window.addEventListener("resize",()=>{const t=o;o=r(),t!==o&&(e=Math.min(e,c()),u())}),u()}function i(){e>0&&(e--,u())}function s(){const t=c();e<t&&(e++,u())}function u(){if(!t)return;const n=c();e=Math.min(e,n);const l=(e*100)/o;t.style.transform=`translateX(-${l}%)`,t.style.transition="transform 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)";const i=document.querySelector(".carousel-btn-prev"),s=document.querySelector(".carousel-btn-next");i&&(i.style.opacity=0===e?"0.3":"1",i.style.pointerEvents=0===e?"none":"auto"),s&&(s.style.opacity=e>=n?"0.3":"1",s.style.pointerEvents=e>=n?"none":"auto")}"loading"===document.readyState?document.addEventListener("DOMContentLoaded",l):l()})();
